...
Then the system should display an error message: "You have already reviewed this seller"
...
Then the system should display an error message: "Invalid rating. Please provide a rating between 1 and 5."
...
When the user "buyer123" writes a review for the seller "fakeuser@mail.com" with:
  | rating | message                 | 
  | 4      | "Nice transaction!"     |
Then the system should display an error message: "Seller not found"
...
Then the system should display an error message: "You cannot review yourself"
...
When the user "buyer123" attempts to update a review for the seller "seller002@mail.com" with:
  | newRating | newMessage                |
  | 5         | "Great experience!"       |
Then the system should display an error message: "You have not reviewed this seller"
